...
from person_object_detection.config import DEVICE, NUM_CLASSES, NUM_WORKERS
from torchmetrics.detection.mean_ap import MeanAveragePrecision
from indoor_object_detection.indoor_model import create_model
from person_object_detection.datasets import create_valid_dataset, create_valid_loader
